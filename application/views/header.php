...
<head>
  ...
  <link rel="icon" href="<?= base_url('assets/login/')?>images/logo_pu.jpg" type="image/gif">
    <!-- overlayScrollbars -->
...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="<?= base_url('assets/adminlte/')?>index3.html" class="brand-link">
      <img src="<?= base_url('assets/login/')?>images/logo_pu.jpg"
           alt="AdminLTE Logo"
           class="brand-image img-circle elevation-3"
           style="opacity: .8">
      <span class="brand-text font-weight-light">SIRUSUN v3.0</span>
    </a>
